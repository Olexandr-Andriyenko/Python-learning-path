...
|[APIs (Application Programming Interfaces)](https://github.com/Olexandr-Andriyenko/Python-learning-path/blob/main/APIs%20(Application%20Programming%20Interfaces).md)| || ||
...
| [Turtle race game](https://github.com/Olexandr-Andriyenko/Python-learning-path/blob/main/Turtle%20race%20game.md) | :star: :star: :star: | Master the turtle module by using different methods of the Turtle() class. Improve the use of turtle coordinate system, events, oop concepts and turtle textinput. |
...
|[Quizz app with API](https://github.com/Olexandr-Andriyenko/Python-learning-path/blob/main/Quizz%20app%20with%20API.md)| ||
