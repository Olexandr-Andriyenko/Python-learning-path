...
|[Loops](https://github.com/Olexandr-Andriyenko/Python-learning-path/blob/main/Loops.md)| Beginner |How to use the for and while loop to repeat code sections. Also the use of the keyword "break" to get more "control" of the corrent loop block. Using the "range()" function to create a sequence of numbers. |
