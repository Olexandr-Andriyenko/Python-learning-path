...
<details><summary>Use the following list of words:</summary>
...
# Generate as many blanks as letters in the random word, for this we need the amount of blanks
number_blanks = len(random_word)
# print for testing!
# print(random_word)
guessed_word = []
for blanks_num in range(0, number_blanks):
...
|_| |_|\__,_|_| |_|\__, |_| |_| |_|\__,_|_| |_|
                   ...
                   |___/    
''')
# Set the amount of lives in the game
lives = 7
# Repeat guessing as long the player have more than 0 lives
while lives > 1:
    # Check if the word is complete
    # Convert a list in string
    guessed_word_string = "".join(guessed_word)
    if guessed_word_string == random_word:
        print("Well done!")
        break
    # Ask the user to guess a letter
    guessed_letter = input("Guess a letter: ")
    # Is the guessed letter in the random word?
    if guessed_letter in random_word:
        # If the guessed letter is true replace the blanks
        # Find the position which have to be replaced with the letter
        for position in range(0, len(random_word)):
            if guessed_letter == random_word[position]:
                guessed_word[position] = guessed_letter
        # Display ascii art
        print(lives_ascii[lives - 1])
        print(guessed_word)
    else:
        # Wrong guess will cost one live
        lives -= 1
